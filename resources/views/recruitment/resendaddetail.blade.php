...
<div class="container job_board">
	...
	<div class="form-group row">
        <label for="inputEmail" class="col-form-label">Broadcast as *</label>
        <div class="col-sm-5">
	...
	<div class="form-group row">
	<div  class="col-md-12"><h5>Industry and Sector Information</h5></div>
	<div  class="col-md-2">
	...
	<div class="form-group row">
	 ...
	 <div  class="col-md-12"><h5>Main Description Details</h5></div>
       <div class="col-md-3"> <label for="inputPassword" class="col-form-label">Job Summary/Introduction *</label></div>
        <div class="col-md-8">
             <textarea class="ckeditor"rows="4"cols="50"" name="jsum">@if(session('details.jsum')) {{session('details.jsum')}} @else {{$disAd['job_summary']}} @endif</textarea>
        </div>
    </div>
	<div class="form-group row">
	<div class="col-md-3">
        ...
        <div class="col-md-8">
            <textarea class="ckeditor"rows="4"cols="50"" name="djob">@if(session('details.djob')) {{session('details.djob')}} @else {{$disAd['detail_job_summary']}} @endif</textarea>
        </div>
    </div>
